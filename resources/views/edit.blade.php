                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                class="form-control @error('client_name') is-invalid @enderror" value="{{$editBookings->client_name}}" />
                                    {{-- Throw an input error --}}
                                    @error('client_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <input type="text" name="client_phone_number"
                                        class="form-control @error('client_phone_number') is-invalid @enderror" value="{{ $editBookings->client_phone_number }}"/>
                                    {{-- Throw an input error --}}
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <input type="number" class="form-control @error('number_of_labour') is-invalid @enderror"
                ...
                <div class="card border border-light shadow-0 mb-3 mx-auto" style="max-width: 20rem">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <select name="vehicle" class="form-control @error('vehicle') is-invalid @enderror" value="{{ old('vehicle') }}">
                                <option value="Select a vehicle" onclick="imagesliderFN('{{ asset('img/default.jpg')}}')">Select
                                    Vehicle</option>
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="4">
                                    <input type="text" name="dropoff_address" value="{{ $editBookings->dropoff_address }}"
                            ...
                            <tr>
                                <td colspan="2">Phone number</td>
                                <td colspan="4">
                                    <input type="text" class="form-control @error('courier_phone_number') is-invalid @enderror"
